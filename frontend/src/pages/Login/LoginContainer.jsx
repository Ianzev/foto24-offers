        ...
        <>
            <div className={styles['login-container']}>
                <div className={styles.wrapper}>
                    <div className={`${styles.container} ${isLoginForm ? '' : styles.active} ${styles['main-container']}`}>
                        {isLoginForm ? (
                            <>
                                ...
                                <div className={styles['toggle-container']}>
                                    <div className={styles.toggle}>
                                        <div className={`${styles['toggle-panel']} ${styles['toggle-right']}`}>
                                            ...
                                            <Link to='/register'><button className={styles['button-form']} id='register' onClick={toggleForm}>Sign Up</button></Link>
                                        </div>
                                    </div>
                                </div>
                                {showErrorLoginAlert && (
                                    <Alert message="Please verify your email and password and try again" result={false} onClose={() => setShowSuccessAlert(false)} />
                                )}
                            </>
                        ) : (
                            <>
                                ...
                                <div className={styles['toggle-container']}>
                                    <div className={styles.toggle}>
                                        <div className={`${styles['toggle-panel']} ${styles['toggle-left']}`}>
                                            ...
                                            <Link to='/login'><button className={styles['button-form']} id='login' onClick={toggleForm}>Sign In</button></Link>
                                        </div>
                                    </div>
                                </div>
                            </>
                ...
                {showSuccessRegistrationAlert && (
                    <Alert message="Registration successful! You can log in now!" result={true} onClose={() => setShowSuccessAlert(false)} />
                )}
                {showErrorRegistrationAlert && (
                    <Alert message="Registration failed! This email is already assigned to an account" result={false} onClose={() => setShowRegErrorAlert(false)} />
                )}
            </div>
        </>
    );
